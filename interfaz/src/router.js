...
export default new VueRouter({
  ...
  routes: [
    ...
    { path: '/register', component: load('auth/register') },
    {
      ...
      children: [
        { path: 'profile', component: load('profile/profile'), meta: { title: 'Perfil de Usuario' } },
        { path: 'reporta', component: load('reporta/reporta'), meta: { title: 'Haz tu Reporte' } },
        { path: 'registrat', component: load('registrat/registrat'), meta: { title: 'Registra tu Tropa' } }
      ]
    },
